...
import pages.BIT_HomePage_page;
	...
	public void user_verifies_contact_head_titles(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
		Thread.sleep(4000);
	...
	public void user_verifies_contact_informations(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
		Thread.sleep(4000);
		   List<String> actualTopMenus=Utility.webElementToStringList(con.contactInformation) ;
	...
	public void user_verifies_head_titles_of_registration_table(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
		Thread.sleep(4000);
